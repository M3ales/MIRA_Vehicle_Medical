...
[QUOTE(GVAR(Unstable_ThresholdLowBP)), "SLIDER", ["Low Heart Rate Threshold", "Value below which a given patient will have 'low' heart rate"], , [1, 120, 50, 0], 0, {}] call CBA_fnc_addSetting;
